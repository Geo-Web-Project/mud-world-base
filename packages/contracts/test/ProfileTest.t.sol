...
import { SnapSyncSystem } from "@latticexyz/world/src/modules/snapsync/SnapSyncSystem.sol";
...
contract ProfileTest is MudTest {
  ...
  function testSnapSync() view public {
    SnapSyncSystem(address(world)).getNumKeysInTable(NameTableId);
  }
