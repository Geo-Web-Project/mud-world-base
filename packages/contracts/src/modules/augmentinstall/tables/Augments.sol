...
library Augments {
  ...
  // Hex-encoded value schema of (address, bytes32, string, bytes32[])
  Schema constant _valueSchema = Schema.wrap(0x00340202615fc5c1000000000000000000000000000000000000000000000000);
  ...
  function set(
    ...
    EncodedLengths _encodedLengths = encodeLengths(augmentMetadataURI, installedEntities);
  ...
  function set(ResourceId _tableId, bytes32 key, AugmentsData memory _table) internal {
    ...
    EncodedLengths _encodedLengths = encodeLengths(_table.augmentMetadataURI, _table.installedEntities);
  ...
  function decodeStatic(bytes memory _blob) internal pure returns (address augmentAddress, bytes32 argumentsHash) {
    augmentAddress = (address(Bytes.getBytes20(_blob, 0)));

    argumentsHash = (Bytes.getBytes32(_blob, 20));
  }
  ...
  function encodeLengths(
    ...
    unchecked {
      _encodedLengths = EncodedLengthsLib.pack(bytes(augmentMetadataURI).length, installedEntities.length * 32);
    }
  }
