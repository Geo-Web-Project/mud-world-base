...
import { AugmentInstallSystem } from "./../../modules/augmentinstall/AugmentInstallSystem.sol";
...
interface IPCOOwnershipSystem {
  ...
  function registerParcelNamespace(uint256 parcelId, AugmentInstallSystem augmentInstallSystem) external;
