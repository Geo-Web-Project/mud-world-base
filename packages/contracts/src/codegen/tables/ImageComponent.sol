...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14("geoweb"), bytes16("ImageComponent")))
);
ResourceId constant ImageComponentTableId = _tableId;
...
library ImageComponent {
   ...
   */
  function get(bytes32 key) internal view returns (ImageComponentData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 key) internal view returns (ImageComponentData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function get(IStore _store, bytes32 key) internal view returns (ImageComponentData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function set(bytes32 key, ImageEncodingFormat encodingFormat, bytes memory contentHash) internal {
   ...
   * @notice Set the full data using individual values.
   */
  function _set(bytes32 key, ImageEncodingFormat encodingFormat, bytes memory contentHash) internal {
    bytes memory _staticData = encodeStatic(encodingFormat);
   ...
   */
  function set(IStore _store, bytes32 key, ImageEncodingFormat encodingFormat, bytes memory contentHash) internal {
    bytes memory _staticData = encodeStatic(encodingFormat);
   ...
   */
  function set(bytes32 key, ImageComponentData memory _table) internal {
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 key, ImageComponentData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.encodingFormat);
   ...
   */
  function set(IStore _store, bytes32 key, ImageComponentData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.encodingFormat);
