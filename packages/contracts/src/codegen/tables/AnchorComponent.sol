...
library AnchorComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "anchor";
    _fieldNames[1] = "position";
    _fieldNames[2] = "orientation";
    return ("AnchorComponent", _fieldNames);
  }
  ...
  function setAnchor(bytes32 key, bytes32 anchor) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((anchor)));
  }
  ...
  function setAnchor(IStore _store, bytes32 key, bytes32 anchor) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((anchor)));
  }
  ...
  function setPosition(bytes32 key, bytes memory position) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 1, bytes((position)));
  }
  ...
  function setPosition(IStore _store, bytes32 key, bytes memory position) internal {
    ...
    _store.setField(_tableId, _keyTuple, 1, bytes((position)));
  }
  ...
  /** Get an item of position (unchecked, returns invalid data if index overflows) */
  ...
  /** Get an item of position (using the specified store) (unchecked, returns invalid data if index overflows) */
  ...
  function setOrientation(bytes32 key, bytes memory orientation) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 2, bytes((orientation)));
  }
  ...
  function setOrientation(IStore _store, bytes32 key, bytes memory orientation) internal {
    ...
    _store.setField(_tableId, _keyTuple, 2, bytes((orientation)));
  }
  ...
  /** Get an item of orientation (unchecked, returns invalid data if index overflows) */
  ...
  /** Get an item of orientation (using the specified store) (unchecked, returns invalid data if index overflows) */
  ...
  function encode(
    ...
    _counters[0] = uint40(bytes(position).length);
    _counters[1] = uint40(bytes(orientation).length);
