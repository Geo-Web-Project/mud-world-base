...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14("geoweb"), bytes16("VideoComponent")))
);
ResourceId constant VideoComponentTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0001010101000000000000000000000000000000000000000000000000000000
);

struct VideoComponentData {
...
library VideoComponent {
   ...
   */
  function getEncodingFormat(bytes32 key) internal view returns (VideoEncodingFormat encodingFormat) {
   ...
   * @notice Get encodingFormat.
   */
  function _getEncodingFormat(bytes32 key) internal view returns (VideoEncodingFormat encodingFormat) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function getEncodingFormat(IStore _store, bytes32 key) internal view returns (VideoEncodingFormat encodingFormat) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function setEncodingFormat(bytes32 key, VideoEncodingFormat encodingFormat) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set encodingFormat.
   */
  function _setEncodingFormat(bytes32 key, VideoEncodingFormat encodingFormat) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function setEncodingFormat(IStore _store, bytes32 key, VideoEncodingFormat encodingFormat) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function get(bytes32 key) internal view returns (VideoComponentData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 key) internal view returns (VideoComponentData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function get(IStore _store, bytes32 key) internal view returns (VideoComponentData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function set(bytes32 key, VideoEncodingFormat encodingFormat, bytes memory contentHash) internal {
   ...
   * @notice Set the full data using individual values.
   */
  function _set(bytes32 key, VideoEncodingFormat encodingFormat, bytes memory contentHash) internal {
    bytes memory _staticData = encodeStatic(encodingFormat);
   ...
   */
  function set(IStore _store, bytes32 key, VideoEncodingFormat encodingFormat, bytes memory contentHash) internal {
    bytes memory _staticData = encodeStatic(encodingFormat);
   ...
   */
  function set(bytes32 key, VideoComponentData memory _table) internal {
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 key, VideoComponentData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.encodingFormat);
   ...
   */
  function set(IStore _store, bytes32 key, VideoComponentData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.encodingFormat);
  ...
  ) internal pure returns (VideoComponentData memory _table) {
