...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("geoweb"), bytes16("IsAnchorComponen")));
bytes32 constant IsAnchorComponentTableId = _tableId;

library IsAnchorComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("IsAnchorComponent", _fieldNames);
  }
