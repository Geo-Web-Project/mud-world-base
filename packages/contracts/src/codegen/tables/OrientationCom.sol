...
library OrientationCom {
   ...
   */
  function get(ResourceId _tableId, bytes32 key) internal view returns (OrientationComData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get the full data.
   */
  function _get(ResourceId _tableId, bytes32 key) internal view returns (OrientationComData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function get(
    ...
    ResourceId _tableId,
    bytes32 key
  ) internal view returns (OrientationComData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function set(ResourceId _tableId, bytes32 key, OrientationComData memory _table) internal {
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(ResourceId _tableId, bytes32 key, OrientationComData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.x, _table.y, _table.z, _table.w);
   ...
   */
  function set(IStore _store, ResourceId _tableId, bytes32 key, OrientationComData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.x, _table.y, _table.z, _table.w);
  ...
  function decodeStatic(bytes memory _blob) internal pure returns (int16 x, int16 y, int16 z, int16 w) {
    ...
    w = (int16(uint16(Bytes.getBytes2(_blob, 6))));
  }
  ...
  function decode(
    ...
    EncodedLengths,
    bytes memory
  ) internal pure returns (OrientationComData memory _table) {
